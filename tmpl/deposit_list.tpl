...
<div class="cabItem depList">
    <span class="captionDark center">your deposit</span>

	<div class="wrap">
        <div class="row">
<center><b>Total: {$currency_sign}{$total}</b></center><br><br>
...
<tr>
 ...
 <th class=inheader width=200>Amount Spent ({$currency_sign})</th>
