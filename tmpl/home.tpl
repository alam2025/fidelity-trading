...
<div class="mainBanner gradImg" style="background-image: url(img/header_bg.jpg);">
    <div class="container">
        <div class="content">
            ...
            <div class="textBlock">
                <p>A distinguished reputation, innovative approach and profitable working conditions are our main advantages and this is why we're the choice of over 100.000 clients.</p>
            </div>
        ...
        <div class="headAdv">
            ...
            <p>All this is only the tip of the iceberg, register on our website in order to experience all the privileges of working with {$settings.site_name}</p>
        </div>
    </div>
...
<div class="about" style="background-image: url(img/about_bg.jpg);">
    <div class="container">
        <div class="cfix">
            ...
            <div class="right">
                <div class="textBlock">
                    <p>The company {$settings.site_name} was founded in 2015 by a group of professional traders with the aim of accumulating assets of several large investors for the most efficient trading on the stock markets. Since the founding of {$settings.site_name}, our principles have been absolute transparency, dedication to our clients, as well as a complete understanding of the features of our profile market and the expectations of different types of investors.</p>
                    <p>Using a unique strategy of the game in the stock markets, our specialists are guaranteed to bring profit to all our partners, so you can not worry about the safety of their funds, despite the potential level of risk of this type of investment.</p>
                </div>
                <div class="btnsWrap">
...
">
    ...
    font-size: 30px;
    color: black;
">UNLEADED GASOLINE</span>
                                <span  style="
    color: black;
">One option = 42,000 gallons</span>
                                <a href="?a=signup" class="btnFillColor1Md"  style="
    color: black;
">Make deposit</a>
                            </div>
...
">Silver</span>
         ...
         <h2 style="
    color: black;
">One Option = 5000 Troy ounces</h2>               
...
">ORANGE JUICE</span>
                                <span  style="
    color: black;
">One Option = 15,000 lbs</span>
                                <a href="?a=signup" class="btnFillColor1Md" style="
    background: #44d29d !important;
    color: black;
">Make deposit</a>
                            </div>
